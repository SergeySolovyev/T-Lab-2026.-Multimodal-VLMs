...
& $Python -m src.train.train_sft --train_npz artifacts/datasets/train.npz --val_npz artifacts/datasets/val.npz --mode action --epochs 2 --output_dir artifacts/sft --model_source lusxvr/nanoVLM-450M --nanovlm_repo external/nanoVLM
